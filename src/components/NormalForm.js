...
const options = [
  ...
  { key: 'mach2', value: 'mach2', text: 'Mach number after shock' },
...
//   { key: 'stagpres', value: 'stagpres', text: 'P02/P01 stagnation pressure ratio' },
//   { key: 'presstagpres', value: 'presstagpres', text: 'P1/P02 pressure to stagnation pressure ratio' },
]
...
export default function NormalForm() {
  ...
  const onSubmit = (values) => {
    ...
    axios
      .get(`https://cors-anywhere.herokuapp.com/https://compflow.herokuapp.com/normalshock/${values.gamma}/${values.inputType}/${values.inputValue}`)
      .then(res => {
        setData(res.data)
        setReqErr('')
      })
